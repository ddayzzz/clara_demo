...
from . import AdaptiveOptimizer, SGD
...
class AdaptiveAggregator:
    ...
    def __init__(self,
        ...
        self.logger.debug('optimizer select: {0}, initialized with parameters : {1}, server_lr: {2}'.format(algo_optimizer, algo_kws, server_lr))
